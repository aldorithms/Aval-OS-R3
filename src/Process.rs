...
impl Process 
{
    ...
    -> Self 
        {
            Process { id, stack_pointer, program_counter, }
        }
}
...
-> isize 
    {
        ...
        let process = Process::new(id, stack.top(), entry_point);
        processes.push(process);
        processes.len() as isize - 1
    }
...
pub fn switch_process(new_process: &Process) 
{
    ...
    current_process.cpu_state = CpuState::from_registers();
